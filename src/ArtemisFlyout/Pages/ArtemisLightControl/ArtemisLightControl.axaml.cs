...
namespace ArtemisFlyout.Pages
{
    public class ArtemisLightControl : ReactiveUserControl<ArtemisLightControlViewModel>
    {
        public ArtemisLightControl()
        {
            ...
            AttachedToVisualTree += ArtemisLightControl_AttachedToVisualTree;
        }

        private void ArtemisLightControl_AttachedToVisualTree(object sender, Avalonia.VisualTreeAttachmentEventArgs e)
        {
            ...
            contentTransition.Apply(contentPanel, Avalonia.Animation.Clock.GlobalClock,
                TransformOperations.Parse("translate(-20px, 0px)"), TransformOperations.Parse("translate(0px, 0px)"));
        }
    }
}
